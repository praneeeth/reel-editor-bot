...
- **LEAN_MODE=true (default):** ≤10 timeline_view self-eval checks, no animation overlays,
  revisions start a fresh agent session.
- **Output:** 1080x1920 @ 30fps, ≤180 s, landscape centre-cropped to 9:16, bold-overlay
  captions kept out of the bottom 20% and right 15%. No cut may land inside a word.
